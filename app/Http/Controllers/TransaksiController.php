...
class TransaksiController extends Controller
{
    ...
    public function show(String $id)
    {
        ...
        $detailTransaksi = TransaksiModel::where('penjualan_id', $id)->get();
    ...
    {
        $penjualan = TransaksiPenjualanModel::find($id);
        $detailPenjualan = TransaksiModel::where('penjualan_id', $id)->first();
        $user = UserModel::all();
    ...
    public function update(Request $request, $id)
    {
        ...
        $detailPenjualan = TransaksiModel::where('penjualan_id', $id)->first(); // Menggunakan first() untuk mendapatkan objek tunggal
    ...
    public function destroy(string $id)
    {
        ...
        try {
            ...
            TransaksiModel::where('penjualan_id', $id)->delete();
